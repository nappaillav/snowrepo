...
import common.ogb_utils as ogb_utils
...
def main(args: DictConfig):
    ...
    if args.project_name == '': args.project_name = f'SPF+{args.env}+{args.seed}'
    ...
    ############# SETUP WANDB TODO ################
    if not args.debug:
        wandb.init(project=args.wandb_project, group='SPF', name=args.project_name)
    ...
    agent = SPF.Agent(obs_shape=obs_shape, action_dim=action_dim, max_action=max_action,
